...
$creds = 'Copyright '.'[footer_copyright]' . ' Base: <a href="http://www.wordpress.org" target="_blank">WordPress</a> , <a href="http://www.studiopress.com/features" target="_blank">Genesis Framework</a>
 :: '. '[footer_loginout]';
return $creds;
}
